                            ...
                            <div class="table-responsive">
                                <table style="color:#000;margin-bottom: 0px;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <select name="payment_type" id="payment_type"
                                                        v-model="purchase.payment_type" class="form-control"
                                                        style="padding: 1px;">
                                    ...
                                    <tr style="display: none;"
                                        :style="{display: purchase.payment_type == 'bank' ? '' : 'none'}">
                                        <td>
                                            <div class="form-group">
...
new Vue({
    ...
    methods: {
        ...
        savePurchase() {
            ...
            this.purchase.account_id = this.selectedAccount != null && this.selectedAccount.account_id != '' ?
                this.selectedAccount.account_id : null;
