                            ...
                            <div class="col-md-9">
                                <form v-on:submit.prevent="addToCart()">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <v-select id="product" v-bind:options="products" v-model="selectedProduct"
                                                label="display_text" v-on:input="onChangeProduct"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" class="form-control" v-model="total" ref="total"
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <tbody style="display:none" v-bind:style="{display:cart.length > 0 ? '' : 'none'}">
                        <tr v-for="(product, sl) in cart">
                            ...
                            <td><input type="number" v-model="product.quantity"
                                    v-on:input="onChangeCartQuantity(product.product_id)"></td>
                            <td>{{ product.total }}</td>
