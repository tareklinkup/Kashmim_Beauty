                ...
                <div class="col-xs-6">
                    <table class="balancesheet-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Cash Transfer In</td>
                                <td style="text-align:right;">{{ totalCashTransferReceived | decimal }}</td>
                            </tr>
                ...
                <div class="col-xs-6">
                    <table class="balancesheet-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Cash Trunsfer</td>
                                <td style="text-align:right;">{{ totalCashTransfer | decimal }}</td>
                            </tr>
...
new Vue({
    ...
    computed: {
        ...
        totalCashIn() {
            return parseFloat(this.totalSales) +
                ...
                parseFloat(this.totalCashTransferReceived) +
    ...
    methods: {
        async getStatements() {
            ...
            await this.getCashTransferReceived();
            await this.getCashTransfer();
        ...
        async getCashTransferReceived() {
            ...
            await axios.post('/get_cash_transfer_received', filter)
                .then(res => {
                    this.cashTransferReceived = res.data.filter((e) => {
                        return e.status != 'p'
                    });
                })
        },
        ...
        async getCashTransfer() {
            ...
            await axios.post('/get_cash_transfers', filter)
                .then(res => {
                    this.cashTransfer = res.data.filter((e) => {
                        return e.status != 'd'
                    });
                })
        },
