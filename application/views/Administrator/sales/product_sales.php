...
<div id="sales" class="row">
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        ...
        <div class="row">
            <div class="form-group">
                <label class="col-sm-1 control-label no-padding-right"> Courier </label>
                <div class="col-sm-2">
                    <v-select v-bind:options="couriers" v-model="selectedCourier" label="Courier_Name"
                        placeholder="Select Courier"></v-select>
                </div>
            </div>

            <div class="form-group" v-if="couriers.length > 0 && selectedCourier != null">
                <label class="col-sm-1 control-label no-padding-right"> Courier no </label>
                <div class="col-sm-2">
                    <input type="text" id="courierNo" class="form-control" v-model="sales.courierNo" />
                </div>
            </div>
...
new Vue({
    ...
    methods: {
        ...
        getCouriers() {
            axios.get('/get_couriers').then(res => {
        ...
        addToCart() {
            ...
            if (this.selectedBranch.brunch_id != 1) {
        ...
        async saveSales() {
            ...
            if (this.selectedCourier != null && this.sales.courierNo == '') {
                alert('Please Give Courier Number');
                return;
            }
            ...
            if (this.sales.payment_type == 'bank' && this.selectedAccount.account_id == '') {
                alert('Select a Bank Account');
                return;
            }

            this.sales.account_id = this.selectedAccount != null ? this.selectedAccount.account_id : null;
            ...
            if (this.selectedCourier != null && this.selectedCourier.Courier_SlNo != null) {
                this.sales.courierId = this.selectedCourier.Courier_SlNo;
            } else {
                this.sales.courierId = null;
            }
        ...
        async getSales() {
            await axios.post('/get_sales', {
                ...
                this.sales.courierNo = sales.courierNo;
