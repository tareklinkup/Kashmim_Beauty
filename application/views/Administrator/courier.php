    ...
    <div class="col-xs-12">
        ...
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" id="couriername" name="couriername" placeholder="Courier Name" value=""
...
function submit() {
    ...
    var inputdata = 'couriername=' + couriername;
    var urldata = "<?php echo base_url(); ?>insertcourier";
    $.ajax({
        type: "POST",
        url: urldata,
        data: inputdata,
...
function deleted(id) {
    ...
    var urldata = "<?php echo base_url();?>courierdelete";
    if (confirmation) {
        $.ajax({
            type: "POST",
            url: urldata,
